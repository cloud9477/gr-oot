...
class 5oot3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "5oot3")
        ...
        self.oot_multiplypy_0 = oot.multiplypy()
...
def main(top_block_cls=5oot3, options=None):
